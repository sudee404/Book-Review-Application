			...
			<Card>
				...
				<CardContent>
					...
					<Typography variant="div" color="text.secondary">
						<Typography variant="body2" color="text.primary" mb={1} noWrap>
				...
				<CardActions>
					<Button size="small" onClick={() => {router.push(`/books/${properties?.id}`);}}>Learn More</Button>
				</CardActions>
			</Card>
	);
}
		...
		<Grid item xs={12} md={6} lg={4} xl={3}>
			<Card>
				...
				<CardActions sx={{ display: "flex" }}>
					<Skeleton variant="text" width={90} height={40} sx={{mx:1}} />
				</CardActions>
			</Card>
		</Grid>
	);
